...
xst -ifn xst.scr
move dcm_recfg_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\dcm_recfg.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_recfg.ucf dcm_recfg_exdes

echo 'Running map'
map -timing -pr b dcm_recfg_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_recfg_exdes -w routed.ncd routed.vhd
cd ..
