...
xst -ifn xst.scr
move dcm_fixed_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\dcm_fixed.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_fixed.ucf dcm_fixed_exdes

echo 'Running map'
map -timing -pr b dcm_fixed_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm_fixed_exdes -w routed.ncd routed.v
cd ..
