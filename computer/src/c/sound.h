...
//  sender handler is only required for mic threads, use 0 otherwise
audiobuffer* start_snd_device(size_t period, unsigned int rate, int stereo, int direction, sender_handle* sender){
